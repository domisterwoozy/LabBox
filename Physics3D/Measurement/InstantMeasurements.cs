...
namespace Physics3D.Measurement
{
    public static class InstantMeasurements
    {
        ...
        public static BasicBodyMeasurement<double> EnergyMeasurement => new BasicBodyMeasurement<double>("Energy", b => b.Dynamics.Energy);
        ...
        public static double Energy(this IBody b) => b.Measure(EnergyMeasurement);
        ...
        {
            return new InstantVolumeMeasurement<double>($"Total {bodyMeas.Name}", vol, bodyMeas, (sum, b) => sum += bodyMeas.TakeMeasurement(b), sum => sum / vol.TotalVolume);
        }
        ...
        public static InstantVolumeMeasurement<double> TotalEnergy(IVolume vol) => VolumeSum(vol, EnergyMeasurement);
        public static InstantVolumeMeasurement<double> AvgEnergy(IVolume vol) => VolumeAvg(vol, EnergyMeasurement);
        #endregion
    }
}
